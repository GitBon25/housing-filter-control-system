...
export class Store extends EventEmmiter {
    ...
    setState(newState: Record<any, any>, module: Record<any, any> | string = this.state): void {
        let path = ''
...
export class Router extends EventEmmiter {
    ...
    async initPage(page: (new (...args: any[]) => any) | null, getPage = false) {
